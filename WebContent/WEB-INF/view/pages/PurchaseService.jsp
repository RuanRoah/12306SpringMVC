...
<html>
  ...
  <body>
		    	...
		    	<div class="container-fluid">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form class="form-inline" action="queryticket.do" method="post">
						        ...
						        <select class="form-control" id="seat" name="seat">
						       	 <option value="">请选择座等</option>
						         <option value="特等座">特等座</option>
						          <option value="一等座">一等座</option>
						          <option value="二等座">二等座</option> 
						        </select>
						        <label for="datetimepicker">出发时间</label>
						        <input size="16" type="text" value="" class="form-control" name="dates" id="dates" onclick="WdatePicker()">
						        <input type="submit" class="btn btn-info" value="查询余票" id="querybtn"/>
						      </form>
					</div>
				</div>
			</div>
    ...
    <script>
      ...
      $(function(){
    	  $("#mainBody").load("result.do",function(){ $("#showmap").fadeIn(100);});
